---
'@tootallnate/bars': patch
---

New parser package for **BARS** ("Binary Audio Resource System"),
Nintendo's flat audio archive used heavily on the Wii U and Switch —
notably in *The Legend of Zelda: Breath of the Wild* and
*Tears of the Kingdom*, where every animal vocalisation, weapon
